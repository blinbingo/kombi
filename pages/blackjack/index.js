...
export default function Blackjack() {
  ...
  const posicoes = [
    { bottom: '-5px', left: '20%', transform: 'translateX(-50%) rotate(-10deg)' },   // Jogador 1 - corrigido
    ...
    { bottom: '-5px', left: '80%', transform: 'translateX(-50%) rotate(10deg)' },    // Jogador 5 - corrigido
  ];
