...
export default function MesaBlackjack() {
  return (
    ...
    >
      ...
      <JogadorMesa top={525} left={620} rotate={15} nome="Jogador 3" />
      <JogadorMesa top={535} left={800} rotate={0} nome="Jogador 4" />
      <JogadorMesa top={525} left={980} rotate={-15} nome="Jogador 5" />
      <JogadorMesa top={500} left={1160} rotate={-35} nome="Jogador 6" />
